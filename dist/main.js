...
var Tab = function () {
  ...
  _createClass(Tab, [{
    ...
    value: function detachAllEl(template) {
      ...
      try {
        for (var _iterator = sectionsEl[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var sectionEl = _step.value;
    ...
    value: function detachListsEl(el) {
      ...
      try {
        for (var _iterator2 = lisEl[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
},{"./components/tab":1,"./components/timer":3,"babel-polyfill":6}],6:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":7,"core-js/shim":300,"regenerator-runtime/runtime":302}],7:[function(require,module,exports){
